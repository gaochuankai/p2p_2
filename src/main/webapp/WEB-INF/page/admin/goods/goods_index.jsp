    ...
    function loadData(page) {
        $.post("${dynamicURL}/admin/goods/list?page=" + page, function (data) {
            if (data.success) {
                ...
                str += "    <tr>";
                str += "        <th>商品名称</th>";
                str += "        <th class=\"hidden-phone\">商品图片</th>";
                str += "        <th class=\"hidden-phone\">商品数量</th>";
                str += "        <th class=\"hidden-phone\">Joined</th>";
                ...
                $.each(data.list, function (index, element) {
                    ...
                    str += "            <img src=\"${dynamicURL}/image/" + element.titleimage + "\" width=\"90\" height=\"90\" />";
                    str += "        </td>";
                    str += "        <td class=\"hidden-phone\">10</td>";
                    str += "        <td class=\"center hidden-phone\">02.03.2013</td>";
                    str += "        <td class=\"hidden-phone\">";
                    str += "            <button class=\"btn btn-danger\" type=\"submit\" onclick='edit(" + element.id + ")'>修改</button>";
                    str += "            <button class=\"btn btn-danger\" type=\"submit\" onclick='xjia(" + element.id + ")'>下架</button>";
                    str += "        </td>";
                    str += "    </tr>";
                    str += "    </tbody>";
                });
