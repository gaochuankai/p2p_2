...
public class ExcelUtils {
    ...
    public static void exportExcel(List<?> list, String title, String sheetName, Class<?> pojoClass,
                                   String fileName, HttpServletResponse response) throws NormalException {
    ...
    private static void defaultExport(List<?> list, Class<?> pojoClass, String fileName,
                                      HttpServletResponse response, ExportParams exportParams) throws NormalException {
    ...
    private static void downLoadExcel(String fileName,
                                      ...
                                      Workbook workbook) throws NormalException {
        try {
    ...
    public static <T> List<T> importExcel(String filePath, Integer titleRows, Integer headerRows,
                                          Class<T> pojoClass) throws NormalException {
